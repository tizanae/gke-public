...
variable "network" {
  description = "The name of the VPC to deploy the cluster to."
  type        = string
}

variable "environment" {
  description = "The logical environment to deploy the cluster to."
  type        = string
}

variable "created_by" {
  description = "User of service account used to create resource, email prefix e.g. todd_sudduth"
  type        = string
  default     = "cicd_platform_sa"
}
